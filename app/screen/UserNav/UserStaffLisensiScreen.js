...
class UserStaffLisensiScreen extends ValidationComponent {
	...
	async fetchData() {
		...
		//query
		let query = firebase.firestore().collection('userLicense').where('userId', '==', staffId).orderBy('tanggalMulai');
	    ...
	    return (
	    	<PaperProvider theme={theme}>
                ...
                <Button 
		            mode="contained"
		            icon="plus" 
		            onPress={() => this.props.navigation.navigate('UserStaffLisensiPerpanjangScreen', {staffId:this.props.route.params.staffId})}
