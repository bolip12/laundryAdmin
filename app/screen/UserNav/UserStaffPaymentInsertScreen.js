...
class UserStaffPaymentInsertScreen extends ValidationComponent {
	...
	async onSubmit() {
		...
		if(this.isFormValid()) {
	        ...
	        this.props.navigation.navigate('UserStaffPaymentScreen');
		}
	}
	    ...
	    return (
	    	<PaperProvider theme={theme}>
			    <Appbar.Header style={styleApp.Appbar}>
			      <Appbar.BackAction color= {theme.colors.primary} onPress={() => this.props.navigation.navigate('UserStaffPaymentScreen')} />
			      <Appbar.Content title="Profil" color= {theme.colors.primary}/>
			    </Appbar.Header>
...
export default UserStaffPaymentInsertScreen;