...
class UserPaymentScreen extends React.Component {
  ...
  async fetchData() {
    ...
    //query
    let query = firebase.firestore().collection('userPayment').where('uid', '==', userId);
    ...
    return (
      <PaperProvider theme={theme}>
        ...
        <Appbar.Header style={{ backgroundColor: 'white' }}>
          ...
          <Appbar.Content title="User Payment" color= {theme.colors.primary} />
        </Appbar.Header>
        ...
        <Button 
            mode="contained"
            icon="plus" 
            onPress={() => this.props.navigation.navigate('UserPaymentInsertScreen', {userId:this.props.route.params.userId, namaUsaha:this.props.route.params.namaUsaha, licenseDate:this.props.route.params.licenseDate})}
